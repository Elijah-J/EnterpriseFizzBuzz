...
# ============================================================
# CPU Pipeline Exceptions (EFP-CPU0 through EFP-CPU4)
# ============================================================
...
# ---------------------------------------------------------------------------
# FizzGIS Spatial Database Exceptions
# ---------------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Clock Synchronization Exceptions
# ------------------------------------------------------------------
...
# ── FizzBob: Operator Cognitive Load Modeling Exceptions ─────────────
...
# ── FizzApproval: Multi-Party Approval Workflow Exceptions ───────────
...
# ── FizzPager: Incident Paging & Escalation Exceptions ───────────────
...
# ── FizzPerf: Operator Performance Review & 360-Degree Feedback ─────
...
# ================================================================
# OCI Container Runtime Exceptions
# ================================================================
# The OCI runtime specification defines five operations (create,
# start, kill, delete, state) and a four-state lifecycle (Creating,
# Created, Running, Stopped). Each operation can fail in ways that
# the specification does not fully enumerate, because the authors
# wisely left error handling to the runtime implementor. These
# twenty exception classes cover every failure mode encountered
# during container lifecycle management, from configuration schema
# violations to seccomp profile errors to hook execution timeouts.
# ================================================================
...
# ============================================================
# FizzDeploy Container-Native Deployment Pipeline Exceptions
# ============================================================
