...
from .mixins.fizzusb import FizzusbConfigMixin
from .mixins.fizzpcie import FizzpcieConfigMixin
from .mixins.fizzefi import FizzefiConfigMixin
from .mixins.fizzspdk import FizzspdkConfigMixin
from .mixins.fizzdpdk import FizzdpdkConfigMixin
from .mixins.fizzsgx import FizzsgxConfigMixin
...
from .mixins.fizzfpga import FizzfpgaConfigMixin
from .mixins.fizzquantumv2 import Fizzquantumv2ConfigMixin
from .mixins.fizzphotonic import FizzphotonicConfigMixin
...
from .mixins.fizzbrainwave import FizzbrainwaveConfigMixin
from .mixins.fizzswarm import FizzswarmConfigMixin
from .mixins.fizzcellular import FizzcellularConfigMixin
...
from .mixins.fizzmaterialscience import FizzmaterialscienceConfigMixin
from .mixins.fizzfluiddynamics import FizzfluiddynamicsConfigMixin
from .mixins.fizzoptics import FizzopticsConfigMixin
...
class ConfigurationManager(
    ...
    FizzfpgaConfigMixin,
    Fizzquantumv2ConfigMixin,
    FizzphotonicConfigMixin,
    ...
    FizzbrainwaveConfigMixin,
    FizzswarmConfigMixin,
    FizzcellularConfigMixin,
    ...
    FizzmaterialscienceConfigMixin,
    FizzfluiddynamicsConfigMixin,
    FizzopticsConfigMixin,
